# -*- coding: utf-8 -*-
"""Conditions(학생용).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1t2c6efnfbi8o8eoxTHHMxbpzz7Pef_ln
...
if age > 18:
    #within an indent, we have the expression that is run if the condition is true #탭키
  print("you can enter" )
else:
  print("Prohibited")
  print("okay")
